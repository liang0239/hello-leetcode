...
public class AuthenticationTest {
    ...
    public void addUser() {
        // 在方法开始前添加一个用户
        simpleAccountRealm.addAccount("wmyskxz1", "123456", "user");
//        在方法开始前添加一个用户,让它具备admin和user两个角色
        simpleAccountRealm.addAccount("wmyskxz2", "123456", "admin", "user");
    }
    ...
    public void testAuthentication() {
        ...
        UsernamePasswordToken token = new UsernamePasswordToken("wmyskxz1", "123456");
...
//        subject.checkRole("xxx"); // 报错
    ...
    @Test
    public void testAuthenticationMy() {
